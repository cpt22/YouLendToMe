...
INSERT INTO items (title, description, listed, borrowed, location, rate, start_date, end_date, category, owner_ID, deleted, ID) VALUES ('test title', 'test description', 1, 1, 10101, 280.00, '2020-05-05', '2020-06-06', 6, @userID, 1, @itemID);
-- Create test image
