...
//test whether addresses are returned
    public function testAddress(): void {
        $this->assertEquals("test1", $this->user->getAddress()[0]->getLine1());
        $this->assertEquals("test2", $this->user->getAddress()[0]->getLine2());
        $this->assertEquals("testcity", $this->user->getAddress()[0]->getCity());
        $this->assertEquals("teststate", $this->user->getAddress()[0]->getState());
        $this->assertEquals("10101", $this->user->getAddress()[0]->getZipcode());
      }
//test credit card information
    public function testCredit(): void {
        $this->assertEquals("0000000000000000", $this->user->getCredit()[0]->getNumber());
        $this->assertEquals("1", $this->user->getCredit()[0]->getExpMonth());
        $this->assertEquals("2024", $this->user->getCredit()[0]->getExpYear());
        $this->assertEquals("123", $this->user->getCredit()[0]->getCVV());
      }
