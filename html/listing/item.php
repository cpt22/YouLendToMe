...
<body>
  ...
  <div class="row">
  <div class="col redBorder"><img src="image link here" class="rounded float-left" alt="image alternate text here" width="400" height="400"></div>

  <div class="col">
  <div class="row p-2"><h1 class="itemName">Item Name PlaceHolder</h1></div>
  ...
  <div class="container blackBorder">
    <div class="row">
    <div class="col">DESCRIPTION: Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris
